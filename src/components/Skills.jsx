    ...
    <div id="skills">
      ...
      >
        <div className="flex flex-col gap-4 items-center">
          ...
          <p className="text-shading text-center text-sm md:text-base lg:text-xl max-w-3xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 text-xs md:text-sm lg:text-base text-justify w-full max-w-5xl">
            <div className="space-y-4">
              ...
              <ul className="list-disc list-inside pl-4 space-y-1">
                ...
                <li>
                  Data segmentation by region, category, and key attributes
                </li>
              </ul>
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc list-inside pl-4 space-y-1">
                ...
                <li>
                  Google Sheets for analysis, reporting, and collaboration
                </li>
              </ul>
